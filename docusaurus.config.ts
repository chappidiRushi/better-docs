...
const config: Config = {
  ...
  url: 'https://chappidirushi.github.io',
  ...
  plugins: [
    ...
    [
      ...
      {
        debug: false, // set true only when testing
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/chappidirushi/better-docs/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/chappidiRushi/better-docs/',
          label: 'GitHub',
          position: 'right',
        },
        {
